...
export const RenaissanceHero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center px-4 sm:px-6 lg:px-8 pt-16">
      {/* Background glow effects */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-cosmic-main-teal/20 rounded-full blur-3xl animate-pulse-slow" />
      <div
      ...
      <div className="max-w-6xl mx-auto text-center relative z-10">
        ...
        >
          ...
          {/* Subheading */}
          <motion.p
            className="text-xl md:text-2xl text-cosmic-light-green mb-8 max-w-3xl mx-auto leading-relaxed"
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.8, delay: 0.2 }}
          >
            Meet{" "}
            <span className="text-cosmic-vibrant-blue font-semibold">
              Renaissance
            </span>
          ...
          >
            ...
            <motion.a
              href="#features"
              className="border-2 border-cosmic-main-teal hover:bg-cosmic-main-teal px-8 py-4 rounded-xl font-semibold text-lg text-cosmic-light-green hover:text-cosmic-off-white transition-all duration-300"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
            >
              Learn More

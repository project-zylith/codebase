  ...
  const features = [
    {
      ...
      description:
        "Renaissance analyzes your notes and provides intelligent insights, task suggestions, and content organization.",
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-xl text-cosmic-light-green mb-8 max-w-4xl mx-auto leading-relaxed">
            Renaissance combines the power of artificial intelligence with
            beautiful design to create the most intuitive note-taking and task
            management experience you've ever used.
          </p>

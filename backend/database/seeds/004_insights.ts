  ...
  return knex("insights")
    ...
    .then(function () {
      ...
      return knex("insights").insert([
        {
          idea_id: 1, // AI-Powered Task Manager
          content:
        ...
        {
          idea_id: 2, // Collaborative Mind Mapping Tool
          content:
        ...
        {
          idea_id: 3, // Indoor Garden Monitoring
          content:
        ...
        {
          idea_id: 4, // Subscription Box for Local Artisans
          content:
        ...
        {
          idea_id: 5, // Impact of Remote Work on Urban Planning
          content:
        ...
        {
          idea_id: 6, // Sci-Fi Novel: The Memory Traders
          content:
        ...
        {
          idea_id: 7, // Mobile App for Plant Care
          content:

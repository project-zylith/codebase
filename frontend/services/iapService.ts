...
export const SUBSCRIPTION_PLANS: IAPProduct[] = [
  {
    ...
    features: [
      "document-text Up to 20 notes per month",
      "checkmark-circle Up to 30 tasks per month",
      "planet Up to 8 galaxy organizations",
      "bulb 10 AI insights per day",
      "moon Dark mode for notes",
      "card Billed monthly • Cancel anytime",
    ],
  },
  {
    id: "basic_annual",
    ...
    features: [
      ...
      "bulb 10 AI insights per day",
      "moon Dark mode for notes",
      "pricetag Save 17% vs monthly billing",
      "card Billed annually • Cancel anytime",
    ],
  },
  {
    id: "pro_monthly",
    ...
    features: [
      "document-text Unlimited notes",
      "checkmark-circle Unlimited tasks",
      "planet Up to 10 galaxy organizations",
      "bulb 15 AI insights per day",
      "moon Dark mode for notes",
      "star Pro-only features access",
      "card Billed monthly • Cancel anytime",
    ],
  },
  {
